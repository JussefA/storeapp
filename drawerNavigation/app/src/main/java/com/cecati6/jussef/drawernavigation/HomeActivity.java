...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fragmentSelected==false){
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_content_id,defaultFragment).commit();
        }
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            myFragment=new ShopCarFragment();
            fragmentSelected=true;

        } else if (id == R.id.nav_wish_list) {
            myFragment=new WishListFragment();
            fragmentSelected=true;
        ...
        if(fragmentSelected==true){
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_content_id,myFragment).commit();
        }
